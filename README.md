# Проект Музыкальные плейлисты
## Краткое описание
Сервис по ведению музыкальных плейлистов. 
Отображает названия треков, альбомов, исполнителей. Позволяет добавить треки и альбомы в Избранное и в собственные плейлисты, воспроизвести трек через embedded youtube

## [Trello dashboard](https://trello.com/b/ONlSacfp/music-playlist-project) 
